...
INSERT INTO shoplist.shop_lists_items (product_id, shopList_id) VALUES(2, (SELECT id FROM shoplist.shop_lists l WHERE l.name = 'list1' AND l.owner = 'userWith5Lists'));
